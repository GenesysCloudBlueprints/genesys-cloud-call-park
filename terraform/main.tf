...
/*
  Create Call Park Agent Inbound Queue
*/

module "queue_callparkagentinboundqueue" {
  source      = "./modules/routing-queue/callparkagentinboundqueue"
  queue_name  = "Call Park Agent Inbound Queue"
  description = "Call Park Agent Inbound Queue generated by CX as Code"
}
